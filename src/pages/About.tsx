...
import { Users, Calendar, Target, ShieldCheck, BarChart3, Microscope } from 'lucide-react';
  ...
  const pillars = [
    {
      icon: Microscope,
      title: "진단 기술의 혁신",
      description: "글로벌 선두 기업들의 최첨단 체외진단 장비를 선별하여 국내 의료 현장에 신속하게 도입합니다."
    },
    {
      icon: BarChart3,
      title: "공급망의 최적화",
      description: "데이터 기반의 체계적인 재고 관리 시스템을 통해 필수 의료 소모품의 안정적인 공급을 보장합니다."
    },
    {
      icon: ShieldCheck,
      title: "서비스의 전문화",
      description: "제조사 및 전문 기술진과의 긴밀한 파트너십을 통해 현장의 기술적 요구사항을 신속하게 조율하며, 검증된 전문가 네트워크로 차별화된 사후 관리를 제공합니다."
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {pillars.map((item, idx) => (
              <div key={idx} className="relative group">
                ...
                <div className="mt-8 w-12 h-1 bg-gray-100 group-hover:w-full group-hover:bg-brand-point transition-all duration-500" />
              </div>
            ))}
          </div>
        </section>
